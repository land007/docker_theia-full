...
RUN sed -i 's/\r$//' /*.sh ; chmod +x /*.sh && \
	...
	echo "land007/theia-full" >> /.image_names && \
	echo "land007/theia-full" > /.image_name
...
#docker build -t land007/theia-full:latest .
#docker rm -f theia-full; docker run -it --privileged -p 15050:5050 --expose 9229 -p 19229:9229 -v "$(pwd):/home/project:cached" -e "username=land007" -e "password=fcea920f7412b5da7be0cf42b8c93759" --name theia-full land007/theia-full:latest
#docker rm -f theia-full; docker run -it --privileged --expose 1080 -p 1080:1080 --expose 3000 -p 3000:3000 -p 15050:5050 --expose 9229 -p 19229:9229 -v "$(pwd):/home/project:cached" -e "username=land007" -e "password=fcea920f7412b5da7be0cf42b8c93759" --name theia-full land007/theia-full:latest
